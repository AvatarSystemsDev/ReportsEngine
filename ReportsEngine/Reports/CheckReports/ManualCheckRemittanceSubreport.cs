...
{
    public partial class ManualCheckRemittanceSubreport : DevExpress.XtraReports.UI.XtraReport
    {
        int pageCounter = 2;
        bool pageRun = false;
        public ManualCheckRemittanceSubreport()
        {
            InitializeComponent();
            xrPages.PrintOnPage += XrPages_PrintOnPage;
            this.PrintOnPage += RDChecksRemittanceOnly_BeforePrint;
            //groupHeaderBand1.PrintOnPage += GroupHeaderBand2_PrintOnPage;
